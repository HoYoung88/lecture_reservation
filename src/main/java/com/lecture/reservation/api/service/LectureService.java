...
public class LectureService {
    ...
    @Transactional
    public Lecture saveLecture(Lecture lecture, Long venueId) {
        Venue venue = this.venueRepository.findByIdOrThrow(venueId);
    ...
    public Lecture findLecture(long lectureId) {
        return this.lectureRepository.findByIdOrThrow(lectureId);
    }
...
//    }
//
//    private final ConcurrentHashMap<Long, LectureApplicant> lockMap = new ConcurrentHashMap<>();
//
//    /**
//     * 강연 신청자 정보를 저장
//     *
